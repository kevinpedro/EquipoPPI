        ...
        <div class="section text-center">
            <h2 class="title">Imágenes de Producto "{{$product->name}}"</h2>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-primary btn-round">Agregar Nueva Imagen</button>
                    <a href="{{ url('/admin/products')}}" class="btn btn-default btn-round">Volver al listados de productos</a>
                </form>
